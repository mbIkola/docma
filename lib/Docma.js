 ...
 *         @param {String|Boolean} [app.routing.forceIndexFile=false]
 *                Optionally you can set up router to prepend index file to all
 *                generated routes. This might be useful when documentation deployed
 *                to some CDN, which does not provide directory listings index files
 *                (f.e akamai). This configuration property works only for
 *                "query" routing method and "static" server type. <br />
 *                <i> app.routing.forceIndexFile = false </i> SPA routes in this case will
 *                   be generated as `https://CDN_URL/[app.base]/?content=api` <br />
 *                <i> app.routing.forceIndexFile = 'index.html' </i> SPA routes in this case will
 *                   be generated as `https://CDN_URL/[app.base]/index.html?content=api <br />
 *                Use this option only if your hosting does not support directory index files and (or)
