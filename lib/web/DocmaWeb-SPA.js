...
(function () {
    ...
    if (
        ...
        docma.app.routing.forceIndexFile
    ) {
        var indexFile = typeof docma.app.routing.forceIndexFile === "string"
             ? docma.app.routing.forceIndexFile
             : 'index.html';

        pageBase = new RegExp('\/?(:?' + indexFile + ')?')
    }

    page.redirect(pageBase, '');
    ...
    page(pageBase, function (context, next) {
